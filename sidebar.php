...
<li class="pcoded-hasmenu">
    ...
    <ul class="pcoded-submenu">
        <li class="">
            <a href="add-treatment-record.php">
                <span class="pcoded-mtext">Add Treatment Records </span>
            </a>
        </li>
		<li class="">
            <a href="add-Prescription-record.php">
                <span class="pcoded-mtext">Add Prescription record </span>
            </a>
        </li>
		<li class="">
            <a href="add-billing.php">
                <span class="pcoded-mtext">Add Biling </span>
            </a>
        </li>
