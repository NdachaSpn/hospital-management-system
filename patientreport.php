...
?>
    ...
    ?>
        ...
        if($rs['bill_type']  == "Prescription charge")
        {
          ...
          echo " </td><td>&nbsp;Ksh. $rs[bill_amount]</td></tr>";
                        ...
                        <tbody>
                          ...
                          <tr>
                            <th width="442" scope="col"><div align="right">Tax Amount (5%) &nbsp; </div></th>
                              <td width="95">&nbsp;Ksh. <?php echo $taxamt = 5 * ($billamt / 100); ?>
                              </td>
                          </tr>
                           
                      <tr>
                        <th scope="col"><div align="right">Discount &nbsp; </div></th>
                        <td>&nbsp;Ksh. <?php echo $rsbilling_records['discount']; ?></td>
                        </tr>
                          
                      <tr>
                        <th scope="col"><div align="right">Grand Total &nbsp; </div></th>
                        <td>&nbsp;Ksh. <?php echo ($billamt + $taxamt)  - $rsbilling_records['discount'] ; ?></td>
                        </tr>
                        </tbody>
                      </table>
                    </div>
    ...
    ?>
                  ...
                  ?>
                    &nbsp;Ksh. <?php echo $billamt; ?></td>
                          </tr>
                          <tr>
                            <th width="442" scope="col"><div align="right"></div></th>
                            <td width="413">&nbsp;</td>
                            <th width="442" scope="col"><div align="right">Tax Amount (5%) &nbsp; </div></th>
                            <td width="413">&nbsp;Ksh. <?php echo $taxamt = 5 * ($billamt / 100); ?></td>
                          </tr>
                      ...
                      <tr>
                        ...
                        <th scope="col"><div align="right">Grand Total &nbsp; </div></th>
                        <td>&nbsp;Ksh. <?php echo $grandtotal = ($billamt + $taxamt)  - $rsbilling_records['discount'] ; ?></td>
                        </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td>Ksh. <?php echo $balanceamt = $grandtotal - $rspayment[0]  ; ?></td>
                        </tr>
                        </tbody>
                      </table>
                      ...
                      ?>
                          ...
                          <?php       
                              ...
                              ?>
                                   ...
                                   <td>&nbsp;Ksh. <?php echo $rspayment['paidamount']; ?></td>
                                   </tr>
                              <?php
                              }
                          ?>
