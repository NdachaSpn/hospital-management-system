...
<?php
        ...
        while($rs = mysqli_fetch_array($qsql))
        {
		  ...
		  $sqlprescription = "SELECT * FROM prescription WHERE patientid='$rs[patientid]'";
          $prescriptionsqlpat = mysqli_query($conn,$sqlprescription);
          $rsprescription = mysqli_fetch_array($prescriptionsqlpat);
          ...
          <td>&nbsp;$rsdoc[doctorname] <br>&nbsp;$rsdept[departmentname]</td>
          <td>&nbsp;$rs[app_reason]</td>
          <td>";
          ...
          {
            echo "<a href='patientreport.php?patientid=$rs[patientid]&appointmentid=$rs[appointmentid]' class='btn btn-xs btn-primary'>View</a>";
			echo"&nbsp";
			echo "<a href='add-treatment-record.php?editid=$rs[appointmentid]' class='btn btn-xs btn-info'>Treatment</a>";
			echo"&nbsp";
			echo "<a href='add-Prescription-record.php?editid=$rs[appointmentid]' class='btn btn-xs btn-success'>Presc</a>";
			echo"&nbsp";
			echo "<a href='add-billing.php?prescriptionid= $rsprescription[prescriptionid]' class='btn btn-xs btn-danger'>Billing</a>";
          }
          echo "</td></tr>";
        }
        ?>
