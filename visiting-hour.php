...
<form id="main" method="post" action="" enctype="multipart/form-data">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            <input class="form-control"  type="time" name="ftime" id="ftime" value="<?php if(isset($_GET['editid'])) { echo $rsedit['start_time']; } ?>"></td>
            <span class="messages"></span>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            <input  class="form-control" type="time" name="ttime" id="ttime"  value="<?php if(isset($_GET['editid'])) { echo $rsedit['end_time']; } ?>" >
            <span class="messages"></span>
        </div>
    </div>
