...
if(isset($_POST['btn_submit']))
{
    ...
    {
        $sql ="INSERT INTO prescription(treatment_records_id,doctorid,patientid,status,appointmentid)values('$_POST[treatment_records_id]','$_POST[doctorid]','$_POST[patientid]','$_POST[status]','$_POST[appointmentid]')";
...
<form id="main" method="post" action="" enctype="multipart/form-data">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-4">
			...
			<input class="form-control" type="hidden" name="treatment_records_id" id="treatment_records_id" id="loginid" value="<?php if(isset($_GET['editid'])){ echo $rsedit['treatment_records_id'];} ?>"/>
            <span class="messages"></span>
        </div>
        <div class="col-sm-4">
    ...
    <div class="form-group row">
        ...
        { if($rsedit['status'] == 'Active') { echo 'selected'; } } ?>>Urgent Medication</option>
                <option value="Inactive" <?php if(isset($_GET['editid']))
        { if($rsedit['status'] == 'Inactive') { echo 'selected'; } } ?>>No Medication</option>
            </select>
            <span class="messages"></span>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <button type="submit" name="btn_submit" class="btn btn-primary m-b-0">Submit Prescription</button>
        </div>
    </div>
